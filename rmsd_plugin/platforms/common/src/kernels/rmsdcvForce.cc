// This file contains kernels to compute the RMSDCV and its gradient using the algorithm described
// in Coutsias et al, "Using quaternions to calculate RMSDCV" (doi: 10.1002/jcc.20110).
...
/**
 * Perform the first step of computing the RMSDCV.  This is executed as a single work group.
 */
KERNEL void computeRMSDCVPart1(int numParticles, GLOBAL const real4* RESTRICT posq, GLOBAL const real4* RESTRICT referencePos,
...
/**
 * Apply forces based on the RMSDCV.
 */
KERNEL void computeRMSDCVForces(int numParticles, int paddedNumAtoms, GLOBAL const real4* RESTRICT posq, GLOBAL const real4* RESTRICT referencePos,
